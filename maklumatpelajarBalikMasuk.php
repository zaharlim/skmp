...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/borangbalikmasuk.css" />
...
<div class="row">
    <form class="col s12" action="actionBalikMasuk.php" method="POST">
     <div class="row">
<center><?php $photo = $row['img_path']; echo "<img src=uploaded_files/$photo  style=width:170px;height:170px;border-radius:50%; > " ; ?></center>
     ...
     <div class="row">
		<div class="input-field col s6 tengah">
          <input name="lokasi" type="text" class="validate" style="text-transform:uppercase" value="<?php echo strftime("%A, %d/%m/%Y",strtotime($row['tarikhbalik'])); ?>" readonly>
          <label><font color="#26a69a" size="4"><b>Tarikh Keluar</b></font></label>
        </div>
	 </div>
     <div class="row">
		<div class="input-field col s6 tengah">
          <input name="lokasi" type="text" class="validate" style="text-transform:uppercase" value="<?php echo strftime("%A, %d/%m/%Y"); ?>" readonly>
          <label><font color="#26a69a" size="4"><b>Tarikh Masuk</b></font></label>
        </div>
	 </div>
     <div class="row">
		<div class="input-field col s6 tengah">
          <input name="keluar" type="text" class="validate" value="<?php echo date("h:i A",strtotime($row['masakeluar'])); ?>" readonly>
          <label><font color="#26a69a" size="4"><b>Masa Keluar</b></font></label>
        </div>
	 </div>
     <div class="row">
		<div class="input-field col s6 tengah">
          <input name="masakeluar" type="text" class="validate" value="<?php echo date("h:i A");?>" readonly>
