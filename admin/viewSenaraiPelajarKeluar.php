...
font-size: 16px;"><a href="index.php" class="btn btn-danger square-btn-adjust" data-toggle="modal" data-target="#confirm-delete">Logout</a> </div>
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a class="active-menu" href="#"><i class="fa fa-list-alt fa-2x"></i> Laporan Keluar Bandar<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <center><h2>Senarai Pelajar Keluar Bandar</h2> </center>  
                    </div>
                </div>				
                 <!-- /. ROW  -->
                  <hr />
...
<table id="keluarbandar" class="table table-striped table-bordered" cellspacing="0" width="100%" >
						<thead style="background-color:#ffc266;">
						<tr>
						<th>ID</th>
						<th>Nama</th>
						<th>No NDP</th>
						...
						while ($row = mysqli_fetch_array($result2)){
							$keluar = $row['masakeluar'];
							if ($keluar == NULL){
							$keluar = "TIADA";
							}else{
							$keluar = date("d/m/Y h:i A", strtotime($row['masakeluar']));
							}
							$masuk = $row['masamasuk'];
							if ($masuk == NULL){
							$masuk = "TIADA";
							}else{
							$masuk = date("d/m/Y h:i A", strtotime($row['masamasuk']));
							}
							?>
							<tr>
							...
							<td><a href="deleteKeluarbandar.php?pid=<?php echo $row['pid']; ?>" onclick="return confirm('Padam record?');">Padam</a></td>
