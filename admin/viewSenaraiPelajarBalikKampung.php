...
font-size: 16px;"><a href="index.php" class="btn btn-danger square-btn-adjust" data-toggle="modal" data-target="#confirm-delete">Logout</a> </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <center><h2>Senarai Pelajar Balik Kampung</h2> </center>  
                    </div>
                </div>				
                 <!-- /. ROW  -->
                  <hr />
...
<table id="balikkampung" class="table table-striped table-bordered" cellspacing="0" width="100%">
						...
						while ($row = mysqli_fetch_array($result4)){
							...
							<td><a href="deleteBalikKampung.php?pid=<?php echo $row['pid']; ?>" onclick="return confirm('Padam record?');">Padam</a></td>
