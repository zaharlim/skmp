...
setlocale(LC_ALL, 'ms-MY');
include_once 'database.php';
include_once 'sessionBalik.php';
?>
<!DOCTYPE html>
            ...
            <section>				
                <div id="container_demo" >
                    ...
                    <a class="hiddenanchor" id="tologin"></a>
                        ...
                        <center><h3>MAKLUMAT PELAJAR BALIK KAMPUNG</h3></center>
<div class="row">
    <form class="col s12" action="actionBalik.php" method="POST">
     <div class="row">
<center><?php $photo = $row['img_path']; echo "<img src=uploaded_files/$photo  style=width:170px;height:170px;border-radius:50%; > " ; ?></center>
     ...
     <div class="row">
        <div class="input-field col s6 tengah">
          <input name="nama" type="text" style="text-transform:uppercase" class="validate" value="<?php echo $nama;?>" readonly>
     ...
     <div class="row">
		<div class="input-field col s6 tengah">
          <input name="lokasi" type="text" style="text-transform:uppercase" class="validate" value="<?php echo $row['lokasi'];?>" readonly>
          <label><font color="#26a69a" size="4"><b>Lokasi</b></font></label>
        </div>
	 </div>
     <div class="row">
		<div class="input-field col s6 tengah">
          <input name="tarikh" type="text" style="text-transform:uppercase" class="validate" value="<?php echo strftime("%A, %d/%m/%Y",strtotime($row['tarikhbalik'])); ?>" readonly>
          <label><font color="#26a69a" size="4"><b>Tarikh Keluar</b></font></label>
        </div>
	 </div>
     <div class="row">
		<div class="input-field col s6 tengah">
          <input name="keluar" type="text" class="validate" value="<?php echo date("d/m/Y h:i A");?>" readonly>
          <label><font color="#26a69a" size="4"><b>Masa Keluar</b></font></label>
        </div>
	 </div>
<center>
<a href="logout.php" class="button btn waves-effect waves-light" type="submit" name="action">Back<i class="material-icons left">chevron_left</i></a>
